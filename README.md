# Naive Bayes Classifier in Scikit-Learn with LIME explanations
## Project Description
...
- A **Naive Bayes Classifier** algorithm built using **SciKit-Learn**
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the Naive Bayes Classifier model implemented using **Scikit-Learn** library.
